# Integrate Receiving Response

    ## Task

    Parse and validate Flitt API responses and result statuses.
    ...
    - `source_md/docs/api/order-status.md`
    - `source_md/docs/api/response-codes.md`
