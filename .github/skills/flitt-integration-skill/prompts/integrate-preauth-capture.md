# Integrate Preauth Capture

    ## Task

    Plan or review delayed capture flows.
    ...
    - `source_md/docs/api/delayed.md`
    - `source_md/docs/api/create-capture.md`
    - `source_md/docs/api/get-capture-status.md`
