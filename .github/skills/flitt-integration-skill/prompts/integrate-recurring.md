# Integrate Recurring
    ...
    Plan or review recurring Flitt payments.
    ...
    - Before initiating recurring order, initial order must be created and approved with any type of flow and integration with `required_rectoke` = `Y`
    ...
    - `source_md/docs/getting-started/recurring.md`
    - `source_md/docs/api/create-order-recurring.md`
    - `source_md/docs/api/order-parameters-recurring.md`
