# Flitt curl Example
    ...
    This directory provides source-backed guidance for a Flitt curl integration example.

    ## Executable Code

    README-only guidance. The docs include curl snippets; adapt them with placeholder credentials.
