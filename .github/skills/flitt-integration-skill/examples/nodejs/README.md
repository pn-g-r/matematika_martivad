# Flitt Node.js Example

    ## What This Demonstrates

    This directory provides source-backed guidance for a Flitt Node.js integration example.

    ## Executable Code

    README-only guidance. Use the public node-js-sdk metadata and local docs before adding code.

    ## Source Support

    Check these local sources before adding or changing code:

    - `source/REPOSITORY_INDEX.json: node-js-sdk`
