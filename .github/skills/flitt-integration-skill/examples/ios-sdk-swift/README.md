# Flitt iOS SDK Swift Example

    ## What This Demonstrates

    This directory provides source-backed guidance for a Flitt iOS SDK Swift integration example.

    ## Executable Code

    README-only guidance. Use public ios-sdk metadata and Flitt mobile docs.

    ## Source Support

    Check these local sources before adding or changing code:

    - `source/REPOSITORY_INDEX.json: ios-sdk`
