# Flitt Embedded Checkout Example

    ## What This Demonstrates

    This directory provides source-backed guidance for a Flitt Embedded Checkout integration example.

    ## Executable Code

    README-only guidance for token-based embedded checkout.

    ## Source Support

    Check these local sources before adding or changing code:

    - `source_md/docs/getting-started/embedded.md`
