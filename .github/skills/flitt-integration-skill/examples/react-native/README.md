# Flitt React Native Example

    ## What This Demonstrates

    This directory provides source-backed guidance for a Flitt React Native integration example.

    ## Executable Code

    README-only guidance. Use public react-native SDK metadata.

    ## Source Support

    Check these local sources before adding or changing code:

    - `source/REPOSITORY_INDEX.json: react-native`
