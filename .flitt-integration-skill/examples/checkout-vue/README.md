# Flitt Checkout Vue Example

    ## What This Demonstrates

    This directory provides source-backed guidance for a Flitt Checkout Vue integration example.

    ## Executable Code

    README-only guidance. Use the public checkout-vue repository metadata.

    ## Source Support

    Check these local sources before adding or changing code:

    - `source/REPOSITORY_INDEX.json: checkout-vue`
