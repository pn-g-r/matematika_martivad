# Flitt Python Example

    ## What This Demonstrates

    This directory provides source-backed guidance for a Flitt Python integration example.

    ## Executable Code

    README-only guidance. The signature doc contains a Python signature example.

    ## Source Support

    Check these local sources before adding or changing code:

    - `source/REPOSITORY_INDEX.json: python`
