# Integrate Direct API Payment

    ## Task

    Plan or review direct API payment integration.
    ...
    - `source_md/docs/getting-started/direct.md`
    - `source_md/docs/api/create-order-direct.md`
    - `source_md/docs/pcidss-compliance.md`
