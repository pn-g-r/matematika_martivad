# Integrate Apple Pay
    ...
    Plan or review Flitt Apple Pay integration.
    ...
    - `source_md/docs/api/applepay-getting-started.md`
    - `source_md/docs/api/applepay-web.md`
    - `source_md/docs/api/applepay-direct.md`
