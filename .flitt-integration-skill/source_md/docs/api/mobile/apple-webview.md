...
You can use **web-view** integration of Apple Pay in your mobile application.
...
As soon as Apple Pay button is clicked, `request()` function will be executed to request new `token` from your backend endpoint from Step 1.
Apple Pay button will use `token` string returned.
